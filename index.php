...
<header class="header-container">
        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="paket_umkm_index.html">Paket & Harga</a></li>
                    <li class="nav-item"><a class="nav-link" href="hosting_index.html">Hosting</a></li>
                    <li class="nav-item"><a class="nav-link" href="domain_index.html">Domain</a></li>
    ...
    <form action="store_index.php" method="GET" class="search-container">
...
<div class="container text-center">
    ...
    <p>Selamat Datang, Marcellino Natanael. Silahkan pilih desain yang sesuai dengan kebutuhan usahamu!</p>
</div>
...
<div class="container mt-5">
    ...
    <div class="gallery-container-product">
        <div class="gallery-item" onclick="window.location.href='store_index.php'">
...
<section class="why-us">
  <div class="container">
    <h2 class="section-title">Apakah Anda Memerlukan Bantuan?</h2>
    <p class="description">
      Silahkan hubungi kami jika ada pertanyaan terkait pembuatan website, kami akan siap menjawab semua pertanyaan anda!
    </p>
    <p class="description">Bagaimana cara menghubungi kami?</p>
    <li class="description">Hubungi kami melalui Nomer Whatsapp Business.</li>
    <li class="description">Hubungi kami melalui Email.</li>
    <li class="description">Hubungi kami melalui Nomer Whatsapp Admin yang tertera.</li>
    <li class="description">Hubungi kami melalui Nomer Whatsapp Admin yang tertera.</li>
  </div>
</section>
...
<section id="contact" class="py-8 bg-white text-center">
  ...
  <div class="contact-box">
    ...
    <p>Alamat: Alamat: Jl. Lodan Raya No.2, RT.12/RW.2, Ancol, Kec. Pademangan, Jkt Utara, Daerah Khusus Ibukota Jakarta 14430</p>
  </div>
</section>
